...
## ReLU aproxima funções não-lineares

![](images/relu-exemplos1.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos2.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos3.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos4.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos5.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos5a.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos6.png){fig-align="center"}

## ReLU aproxima funções não-lineares

![](images/relu-exemplos7.png){fig-align="center"}
...
* Vetores $(X_1, X_2)$ e $(X_3, X_4)$.

* Determinante da matriz $2 \times 2$?
